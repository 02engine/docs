...
**We can't speak on behalf of the Scratch Team**, but we will note a few things:
 ...
 - Regardless of section 4.4, you shouldn't upload projects to Scratch that force people to use 02Engine or any other mod. It's probably okay to suggest it, but you must let that suggestion be easily ignored.
 ...
 - 02Engine is "a modified version of the Scratch editor".
