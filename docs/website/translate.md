...
# Help Translate 02Engine

We're looking for people to help translate 02Engine into languages other than English. If that interests you, read on.

## Requirements to join as a translator {#requirements}

 - You must be **FLUENT IN THE ENGLISH LANGUAGE**.
 - For example, you’re fluent if you can use 02Engine in English, or if you understand griffpatch’s videos. If you struggle to understand sentences without a translator, you’re not fluent.
...
If you don’t own a Scratch account, please send an email to contact@02engine.org instead.

### 2. Create a Transifex account

1. Go to [Transifex open-source Sign up](https://app.transifex.com/signup/open-source/?join_org=02Engine&join_project=02Engine).  
...
If you already own a Transifex account and don’t want to create a new one, please send an email to translation@02engine.org indicating your Transifex account’s username. Then, continue with the "requesting a language" section below.

### 3. Requesting a language

1. Make sure you’re logged in to Transifex. If you just signed up, you are already logged in.
2. Go to [02Engine's Transifex page](https://app.transifex.com/join/?o=02Engine&p=02Engine&t=opensource).
...
:::warning
If your request is denied, you’ll receive an email. If you believe this was a mistake, please send an email to contact@02engine.org indicating your Transifex username. See below for other contact methods. 
:::
...
If you have any questions about translating, you may choose one of the following options:
 ...
 - Send an email to contact@02engine.org.
 - [Open a discussion on GitHub](https://github.com/02Engine/scratch-gui/discussions) (GitHub account required).
