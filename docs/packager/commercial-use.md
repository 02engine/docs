...
# Can I sell projects made with the 02Engine Packager?
...
The 02Engine Packager is provided under [a free and open source license](https://github.com/02Engine/packager/blob/master/LICENSE). You can use files generated by the packager in any way **with no license fee and no royalty**. In place of a license fee, we encourage you to [donate to the Scratch Foundation](https://www.scratchfoundation.org/donate).

:::warning
[The 02Engine Packager offers no warranty. The authors can not be held liable for any damages.](https://github.com/02Engine/packager/blob/master/LICENSE#L261-L301)
:::
